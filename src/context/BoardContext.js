...
export const BoardContextProvider = ({ children })=>{
    ...
    useEffect(() => {
        ...
        fetch('https://a2024-backend-peach.vercel.app/board')
    ...
    const deleteHandle = (id) => {
        ...
        fetch(`https://a2024-backend-peach.vercel.app/board/${id}`,{
            method: 'DELETE'
        })
            .then(res=>res.json()) 
            .then(res=>console.log(res));
    ...
    const onSubmitEditHandle = () => {
        ...
        fetch(`https://a2024-backend-peach.vercel.app/board/${editItem.id}`,{
            method: 'PUT',
            headers: {'Content-Type' : 'application/json;charset=utf-8'},
